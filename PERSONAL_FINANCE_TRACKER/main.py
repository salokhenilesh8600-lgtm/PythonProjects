...
class CSV:
    ...
    def get_transactions(cls , start_date, end_date):
        ...
        if filtered_df.empty:
            print("no transactions fopund in the given date range")
        else:
            ...
            print(f"Net Savings:{total_income - total_expense:.2f}.Rs")
        return filtered_df
...
# CSV.get_transactions("14-03-2026","16-03-2026")
...
def main():
    while True:
        ...
        print("\n2. View transcationand summary within a date range")
        print("\n3. Exit")
